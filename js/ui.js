...
// Add SP data attribute and disable button if SP-only
if (btnData.sp === true) {  // lowercase 'sp' to match JSON
  btn.dataset.sp = "true";
  btn.disabled = true;       // lock by default
} else {
  btn.disabled = btnData.used || false; // normal buttons
}
      ...
      console.log(btn.textContent, btn.disabled, btn.dataset.sp);
      console.log("Building button:", btnData.name, btnData.sp, btnData.used);
    });
  },
};
